    ...
    switch (operation) {
      case "extractPostReactions":
        ...
        if (extractPostReactionsParams.start_page)
          body.start_page = extractPostReactionsParams.start_page;
        if (extractPostReactionsParams.end_page)
      ...
      case "extractPostComments":
        ...
        if (extractPostCommentsParams.use_pagination !== undefined)
          body.use_pagination = extractPostCommentsParams.use_pagination;
        if (extractPostCommentsParams.start_page)
          body.start_page = extractPostCommentsParams.start_page;
        if (extractPostCommentsParams.end_page)
      ...
      case "extractProfileReactions":
        ...
        if (extractProfileReactionsParams.start_page)
          body.start_page = extractProfileReactionsParams.start_page;
        if (extractProfileReactionsParams.end_page)
          body.end_page = extractProfileReactionsParams.end_page;
        if (extractProfileReactionsParams.cursor)
      ...
      case "extractProfileComments":
        ...
        if (extractProfileCommentsParams.start_page)
          body.start_page = extractProfileCommentsParams.start_page;
        if (extractProfileCommentsParams.end_page)
          body.end_page = extractProfileCommentsParams.end_page;
        if (extractProfileCommentsParams.cursor)
      ...
      case "extractProfilePosts":
        ...
        if (extractProfilePostsParams.post_type)
          body.post_type = extractProfilePostsParams.post_type;
        if (extractProfilePostsParams.sort_by)
          body.sort_by = extractProfilePostsParams.sort_by;
        if (extractProfilePostsParams.keyword)
          body.keyword = extractProfilePostsParams.keyword;
        if (extractProfilePostsParams.post_date)
          body.post_date = extractProfilePostsParams.post_date;
        if (extractProfilePostsParams.use_pagination !== undefined)
          body.use_pagination = extractProfilePostsParams.use_pagination;
        if (extractProfilePostsParams.start_page)
          body.start_page = extractProfilePostsParams.start_page;
        if (extractProfilePostsParams.end_page)
      ...
      case "extractCompanyPosts":
        ...
        if (extractCompanyPostsParams.post_type)
          body.post_type = extractCompanyPostsParams.post_type;
        if (extractCompanyPostsParams.sort_by)
          body.sort_by = extractCompanyPostsParams.sort_by;
        if (extractCompanyPostsParams.keyword)
          body.keyword = extractCompanyPostsParams.keyword;
        if (extractCompanyPostsParams.post_date)
          body.post_date = extractCompanyPostsParams.post_date;
        if (extractCompanyPostsParams.use_pagination !== undefined)
          body.use_pagination = extractCompanyPostsParams.use_pagination;
        if (extractCompanyPostsParams.start_page)
          body.start_page = extractCompanyPostsParams.start_page;
        if (extractCompanyPostsParams.end_page)
          body.end_page = extractCompanyPostsParams.end_page;
        break;
    }
